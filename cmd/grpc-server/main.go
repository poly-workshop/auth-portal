...
func main() {
	...
	publicMethods := map[string]bool{
		proto.AuthService_GetOAuthCodeURL_FullMethodName: true,
		proto.AuthService_LoginByOAuth_FullMethodName:    true,
		proto.AuthService_LoginByPassword_FullMethodName: true,
		proto.AuthService_GetUserToken_FullMethodName:    true,
	}
