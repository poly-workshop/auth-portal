...
const file_proto_auth_proto_rawDesc = "" +
	"\n" +
	"\x10proto/auth.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1cgoogle/api/annotations.proto\"\\\n" +
	"\tUserToken\x12\x14\n" +
	...
	"\n" +
	"session_id\x18\x01 \x01(\tR\tsessionId2\x8c\x02\n" +
	"\vAuthService\x12[\n" +
	"\x0fGetOAuthCodeURL\x12\x17.GetOAuthCodeURLRequest\x1a\x18.GetOAuthCodeURLResponse\"\x15\x82\xd3\xe4\x93\x02\x0f\x12\r/v1/oauth/url\x123\n" +
	"\fLoginByOAuth\x12\x14.LoginByOAuthRequest\x1a\r.LoginSession\x129\n" +
	"\x0fLoginByPassword\x12\x17.LoginByPasswordRequest\x1a\r.LoginSession\x120\n" +
	"\fGetUserToken\x12\x14.GetUserTokenRequest\x1a\n" +
	".UserTokenB2Z0github.com/poly-workshop/auth-portal/pkg/protopbb\x06proto3"
