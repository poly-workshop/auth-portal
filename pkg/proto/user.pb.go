...
const file_proto_user_proto_rawDesc = "" +
	"\n" +
	"\x10proto/user.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x85\x02\n" +
	"\x04User\x12\x0e\n" +
	...
	"\bUserRole\x12\b\n" +
	"\x04USER\x10\x00\x12\t\n" +
	"\x05ADMIN\x10\x012\xcd\x03\n" +
	"\vUserService\x12N\n" +
	"\n" +
	"CreateUser\x12\x12.CreateUserRequest\x1a\x16.google.protobuf.Empty\"\x14\x82\xd3\xe4\x93\x02\x0e:\x01*\"\t/v1/users\x12E\n" +
	"\x0eGetCurrentUser\x12\x16.google.protobuf.Empty\x1a\x05.User\"\x14\x82\xd3\xe4\x93\x02\x0e\x12\f/v1/users/me\x129\n" +
	"\aGetUser\x12\x0f.GetUserRequest\x1a\x05.User\"\x16\x82\xd3\xe4\x93\x02\x10\x12\x0e/v1/users/{id}\x12E\n" +
	"\tListUsers\x12\x11.ListUsersRequest\x1a\x12.ListUsersResponse\"\x11\x82\xd3\xe4\x93\x02\v\x12\t/v1/users\x12S\n" +
	"\n" +
	"UpdateUser\x12\x12.UpdateUserRequest\x1a\x16.google.protobuf.Empty\"\x19\x82\xd3\xe4\x93\x02\x13:\x01*2\x0e/v1/users/{id}\x12P\n" +
	"\n" +
	"DeleteUser\x12\x12.DeleteUserRequest\x1a\x16.google.protobuf.Empty\"\x16\x82\xd3\xe4\x93\x02\x10*\x0e/v1/users/{id}B0Z.github.com/poly-workshop/auth-portal/pkg/protob\x06proto3"
